...
function(t) {
    ...
    function(t, e, r) {
        ...
        function a(t, e, r) {
            ...
            for (var i in e) if (e.hasOwnProperty(i)) {
                var o = t[i],
                u = e[i]; ! C(u) || !C(o) || M(u) || M(o) || T(u) || T(o) || I(u) || I(o) ? !r && i in t || (t[i] = n(e[i], !0)) : a(o, u, r)
            }
            return t
        }
        function i(t, e) {
        ...
        function l() {
            return A || (A = W.createCanvas().getContext("2d")),
            A
        }
        function s(t, e) {
            if (t) {
        ...
        function g(t, e, r) {
            if (t && e) if (t.forEach && t.forEach === z) t.forEach(e, r);
            else if (t.length === +t.length) for (var n = 0,
            a = t.length; a > n; n++) e.call(r, t[n], n, t);
            else for (var i in t) t.hasOwnProperty(i) && e.call(r, t[i], i, t)
        }
        function m(t, e, r) {
            if (t && e) {
        ...
        function p(t, e, r, n) {
            if (t && e) {
                ...
                for (var a = 0,
                i = t.length; i > a; a++) r = e.call(n, r, t[a], a, t);
                return r
            }
        }
        function v(t, e, r) {
        ...
        function y(t, e, r) {
            if (t && e) for (var n = 0,
            a = t.length; a > n; n++) if (e.call(r, t[n], n, t)) return t[n]
        }
        function w(t, e) {
        ...
        function N(t) {
            for (var e = 0,
            r = arguments.length; r > e; e++) if (null != arguments[e]) return arguments[e]
        }
        function E() {
    ...
    function(t, e) {
        ...
        n.nice = function(t, e) {
            ...
            i = t / a;
            return r = e ? 1.5 > i ? 1 : 2.5 > i ? 2 : 4 > i ? 3 : 7 > i ? 5 : 10 : 1 > i ? 1 : 2 > i ? 2 : 3 > i ? 3 : 5 > i ? 5 : 10,
            r * a
        },
        t.exports = n
    },
    ...
    function(t, e, r) {
        ...
        function l(t, e) { ("week" === t || "month" === t || "quarter" === t || "half-year" === t || "year" === t) && (t = "MM-dd\nyyyy");
            var r = h.parseDate(e),
            n = r.getFullYear(),
            a = r.getMonth() + 1,
            i = r.getDate(),
    ...
    function(t, e, r) {
        ...
        function n(t, e, r, n, a) {
            ...
            e.eachChild(function(c, l) {
                ...
                if ("horizontal" === t) {
                    ...
                    s = i + p,
                    s > n || c.newline ? (i = 0, s = p, o += u + r, u = d.height) : u = Math.max(u, d.height)
                } else {
                    var v = d.height + (m ? -m.y + d.y: 0);
                    f = o + v,
                    f > a || c.newline ? (i += u + r, o = 0, f = v, u = d.width) : u = Math.max(u, d.width)
                }
        ...
        s.box = n,
        s.vbox = a.curry(n, "vertical"),
        s.hbox = a.curry(n, "horizontal"),
        s.getAvailableSize = function(t, e, r) {
            var n = e.width,
            a = e.height,
            i = c(t.x, n),
            o = c(t.y, a),
            l = c(t.x2, n),
            s = c(t.y2, a);
            return (isNaN(i) || isNaN(parseFloat(t.x))) && (i = 0),
            (isNaN(l) || isNaN(parseFloat(t.x2))) && (l = n),
            (isNaN(o) || isNaN(parseFloat(t.y))) && (o = 0),
            (isNaN(s) || isNaN(parseFloat(t.y2))) && (s = a),
        ...
        s.positionGroup = function(t, e, r, n) {
            ...
            e = s.getLayoutRect(e, r, n),
            t.position = [e.x - i.x, e.y - i.y]
        },
    ...
    function(t, e, r) {
        ...
        n.prototype = {
            ...
            calculateTransform: function(t) {
                ...
                n = t.height / e.height,
                a = i.create();
                return i.translate(a, a, [ - e.x, -e.y]),
                i.scale(a, a, [r, n]),
                i.translate(a, a, [t.x, t.y]),
                a
            },
        ...
        a.extendChartView({
            ...
            render: function(t, e, r) {
                ...
                t.layoutInstance.ondraw = function(t, e, r, c) {
                    ...
                    t.setStyle(s.getItemStyle()),
                    t.setStyle({
                        fill: o.getItemVisual(r, "color")
                    }),
                    i.add(t),
                    o.setItemGraphicEl(r, t),
                    a.graphic.setHoverStyle(t, a.util.extend(f.getItemStyle(), {
                        font: h(f, s)
                    }))
                }
            }
            ...
            c = function(t, e) {
                ...
                if (i) {
                    ...
                    T = function(t) {
                        var e = I(t);
                        if (b !== e) return b = e,
                        e ? void n.hover(e.item, e.dimension, t) : void n.hover(void 0, void 0, t)
                    },
                    N = function(t) {
                        var e = I(t);
                    ...
                    k = function(t) {
                        ...
                        for (0 === t && a.push([h[0], h[1], 0]); r--;) {
                            ...
                            a.push([h[0] + t * i * Math.cos( - r / e * 2 * Math.PI), h[1] + t * i * Math.sin( - r / e * 2 * Math.PI) * n.ellipticity, r / e * 2 * Math.PI])
                        }
                        return E[t] = a,
                        a
                    },
                    ...
                    P = function(t, e, r) {
                        ...
                        a && (document.body.appendChild(c), l.save()),
                        l.scale(1 / u, 1 / u),
                        l.translate(M * u / 2, b * u / 2),
                        l.rotate( - r),
                        l.font = n.fontWeight + " " + (i * u).toString(10) + "px " + n.fontFamily,
                        l.fillStyle = "#000",
                        l.textBaseline = "middle",
                        l.fillText(t, v * u, (y + .5 * i) * u);
                        ...
                        for (var C, I, T, N = [], E = x, k = [w / 2, x / 2, w / 2, x / 2]; E--;) for (C = w; C--;) {
                            ...
                            t: {
                                for (; T--;) for (I = p; I--;) if (S[4 * ((C * p + T) * M + (E * p + I)) + 3]) {
                                    ...
                                    C < k[0] && (k[0] = C),
                                    C > k[2] && (k[2] = C),
                                    a && (l.fillStyle = "rgba(255, 0, 0, 0.5)", l.fillRect(E * p, C * p, p - .5, p - .5));
                                    break t
                                }
                    ...
                    O = function(e, r, a, i, o, u, c, l, s) {
                        ...
                        t.forEach(function(t) {
                            if (t.getContext) {
                                ...
                                o.save(),
                                o.scale(1 / u, 1 / u),
                                o.font = n.fontWeight + " " + (h * u).toString(10) + "px " + n.fontFamily,
                                o.fillStyle = f,
                                o.translate((e + a.gw / 2) * p * u, (r + a.gh / 2) * p * u),
                                0 !== l && o.rotate( - l),
                                o.textBaseline = "middle",
                                o.fillText(i, a.fillTextOffsetX * u, (a.fillTextOffsetY + .5 * h) * u),
                                o.restore()
                            } else {
                                var c = document.createElement("span"),
                                g = "";
                                g = "rotate(" + -l / Math.PI * 180 + "deg) ",
                                1 !== a.mu && (g += "translateX(-" + a.fillTextWidth / 4 + "px) scale(" + 1 / a.mu + ")");
                                var m = {
                                    position: "absolute",
                                    display: "block",
                    ...
                    q = function(e, r, n) {
                        return r ? !t.some(function(t) {
                            ...
                            return a.initCustomEvent(e, !0, r, n || {}),
                            !t.dispatchEvent(a)
                        },
                        this) : void t.forEach(function(t) {
                            var a = document.createEvent("CustomEvent");
                            a.initCustomEvent(e, !0, r, n || {}),
                            t.dispatchEvent(a)
                        },
                        this)
                    },
                    j = function() {
                        var e = t[0];
                        if (e.getContext) s = Math.ceil(e.width / p),
                        f = Math.ceil(e.height / p);
                        else {
                            var r = e.getBoundingClientRect();
                            s = Math.ceil(r.width / p),
                            f = Math.ceil(r.height / p)
                        }
                        if (q("wordcloudstart", !0)) {
                            h = n.origin ? [n.origin[0] / p, n.origin[1] / p] : [s / 2, f / 2],
                            d = Math.floor(Math.sqrt(s * s + f * f)),
                            l = [];
                            var a, i, o;
                            if (!e.getContext || n.clearCanvas) for (t.forEach(function(t) {
                                if (t.getContext) {
                                    ...
                                    e.clearRect(0, 0, s * (p + 1), f * (p + 1)),
                                    e.fillRect(0, 0, s * (p + 1), f * (p + 1))
                                } else t.textContent = "",
                                t.style.backgroundColor = n.backgroundColor,
                                t.style.position = "relative"
                            }), a = s; a--;) for (l[a] = [], i = f; i--;) l[a][i] = !0;
                            else {
                            ...
                            if (n.hover || n.click) {
                                for (S = !0, a = s + 1; a--;) C[a] = [];
                                n.hover && e.addEventListener("mousemove", T),
                                n.click && (e.addEventListener("click", N), e.addEventListener("touchstart", N), e.addEventListener("touchend",
                                function(t) {
                                    t.preventDefault()
                                }), e.style.webkitTapHighlightColor = "rgba(0, 0, 0, 0)"),
                                e.addEventListener("wordcloudstart",
                                function F() {
                                    e.removeEventListener("wordcloudstart", F),
                            ...
                            M("wordcloudstart", E);
                            var k = w(function R() {
                                if (o >= n.list.length) return x(k),
                                q("wordcloudstop", !1),
                                void I("wordcloudstart", E);
                                g = (new Date).getTime();
                                var t = D(n.list[o]),
                                e = !q("wordclouddrawn", !0, {
                                    item: n.list[o],
                                    drawn: t
                                });
    ...
    function(t, e, r) {
        ...
        a.registerLayout(function(t, e) {
            ...
            function(r) {
                ...
                f = r.get("maskImage");
                if (f) try {
                    s.drawImage(f, 0, 0, l.width, l.height),
                    n(l)
                } catch(h) {
                ...
                l.addEventListener("wordclouddrawn",
                function(t) {
                    var e = t.detail.item;
